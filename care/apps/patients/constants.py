...
TRANSFER_STATUS = namedtuple(
    "TRANSFER_STATUS", ["PENDING", "ACCEPTED", "REJECTED", "WITHDRAW"]
...
RELATIVE_TYPE_CHOICES = namedtuple(
    "PATIENT_RELATIVE_CHOICES", ["FATHER", "MOTHER", "SIBLING", "SPOUSE", "SON", "DAUGHTER", "FRIEND", "OTHER"]
)(FATHER=2, MOTHER=3, SIBLING=4, SPOUSE=5, SON=6, DAUGHTER=7, FRIEND=8, OTHER=9)
